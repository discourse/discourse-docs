...
describe Docs::DocsController do
  ...
  before do
    ...
    SiteSetting.docs_url_path = "docs"
  end

  describe 'docs data' do
    context 'when any user' do
      it 'should return the right response' do
        get "/#{SiteSetting.docs_url_path}.json"
    ...
    context 'when filtering by tag' do
      ...
      it 'should return a list filtered by tag' do
        get "/#{SiteSetting.docs_url_path}.json?tags=test"
      ...
      it 'should properly filter with more than two tags' do
        get "/#{SiteSetting.docs_url_path}.json?tags=test%7ctest2%7ctest3"
    ...
    context 'when filtering by category' do
      ...
      it 'should return a list filtered by category' do
        get "/#{SiteSetting.docs_url_path}.json?category=#{category2.id}"
      ...
      it 'ignores category filter when incorrect argument' do
        get "/#{SiteSetting.docs_url_path}.json?category=hack"
    ...
    context 'when ordering results' do
      describe 'by title' do
        it 'should return the list ordered descending' do
          get "/#{SiteSetting.docs_url_path}.json?order=title"
        ...
        it 'should return the list ordered ascending with an additional parameter' do
          get "/#{SiteSetting.docs_url_path}.json?order=title&ascending=true"
      ...
      describe 'by date' do
        ...
        it 'should return the list ordered descending' do
          get "/#{SiteSetting.docs_url_path}.json?order=activity"
        ...
        it 'should return the list ordered ascending with an additional parameter' do
          get "/#{SiteSetting.docs_url_path}.json?order=activity&ascending=true"
    ...
    context 'when searching' do
      ...
      it 'should correctly filter topics' do
        get "/#{SiteSetting.docs_url_path}.json?search=banana"
        ...
        get "/#{SiteSetting.docs_url_path}.json?search=walk"
    ...
    context 'when getting topic first post contents' do
      ...
      it 'should create TopicUser if authenticated' do
        expect do
          get "/#{SiteSetting.docs_url_path}.json?topic=#{topic.id}&track_visit=true"
